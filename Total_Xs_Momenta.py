...
num_SIGMA = 20
upper_bound = 1.
new_E_nu = logspace(-1,upper_bound,num_SIGMA)
...
## Make Neutrino Cross Section ##
#for i in range(num_SIGMA):
SIGMA = make_total_xs_dipole_momenta(new_E_nu,1.35)
...
newer_E_nu = logspace(-1.,upper_bound,120)
...
SIGMA_graph_BAR.semilogx(newer_E_nu,SIGMA_new,linestyle='-',linewidth=2,color='green',label='MA = 1.35 GeV')
SIGMA_graph_BAR.errorbar(Minerva_XData,Minerva_XS,yerr=Minerva_Error,marker='s',color='gray',fmt='o',label='Miniboone XS')
SIGMA_graph_BAR.errorbar(Miniboone_XData,Miniboone_XS,yerr=Miniboone_Error,marker='s',color='black',fmt='o',label='Minerva XS')
...
SIGMA_graph_BAR.set_title(r'Neutrino on Carbon Total Cross Section')
...
fig_SIGMA_BAR.savefig("Desktop/Research/Axial FF/Plots/TOTAL_Minerva_XS_MA=1.35GeV.pdf" )